...
export const STORAGE_KEYS = {
  ...
  OLLAMA_UTILITY_MODEL: 'versatile_ollama_utility_model',
  MODEL_THROUGHPUT: 'versatile_model_throughput',
  OLLAMA_NUM_CTX: 'versatile_ollama_num_ctx',
  OLLAMA_REPEAT_PENALTY: 'versatile_ollama_repeat_penalty',
 ...
 * @returns {string}
 */
export function getApiKeyStorageKey(provider: any) {
 ...
 * @returns {string}
 */
export function getEmbeddingStorageKey(cacheKey: any) {
