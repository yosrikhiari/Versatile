// NOTE: Do NOT import from ./blueprints — blueprints.ts already imports from this file.
// Doing so would create a circular dependency.

/** The per-workspace vocabulary the UI substitutes into labels. */
...
const WORKSPACE_CONFIGS: WorkspaceConfig[] = [
  {
    ...
    icon: 'feather',
    description: 'Stories, poems, and any imaginative writing with characters and plot.',
    terminology: {
      bible: 'Story Bible',
      sections: 'Chapters',
  ...
  },
  {
    ...
    label: 'Novel',
    icon: 'book-open',
    description: 'Full-length fiction with chapters, character arcs, and narrative structure.',
    terminology: {
      bible: 'Story Bible',
      sections: 'Chapters',
  ...
  },
  {
    ...
    icon: 'clapperboard',
    description: 'Scripts for film, television, or stage with scene and dialogue formatting.',
    terminology: {
      bible: 'Script Bible',
      sections: 'Scenes',
  ...
  },
  {
    key: 'LEGAL',
    type: 'legal',
    label: 'Legal Contracts & Agreements',
    icon: 'scale',
    description: 'Contracts, agreements, NDAs, and legal documents with formal clause structure.',
    terminology: {
  ...
  },
  {
    ...
    icon: 'cpu',
    description: 'System specs, API docs, architecture designs, and engineering documents.',
    terminology: {
  ...
  },
  {
    key: 'BUSINESS',
    type: 'business',
    label: 'Business Reports & Documentation',
    icon: 'bar-chart-3',
    description: 'Reports, proposals, strategic plans, and business correspondence.',
    terminology: {
  ...
  },
  {
    key: 'RESEARCH',
    type: 'research',
    label: 'Research & Academic Papers',
    icon: 'flask-conical',
    description: 'Academic papers, studies, journal articles, and scientific documentation.',
    terminology: {
      bible: 'Research Base',
      sections: 'Sections',
  ...
  },
  {
    ...
    label: 'Invoice',
    icon: 'file-text',
    description: 'Billing invoices, quotes, estimates, and financial statements.',
    terminology: {
  ...
  },
  {
    ...
    icon: 'mail',
    description: 'Email campaigns, newsletters, and outreach sequences.',
    terminology: {
  ...
  },
  {
    ...
    icon: 'book-copy',
    description: 'User manuals, how-to guides, FAQs, and product documentation.',
    terminology: {
  ...
  },
  {
    ...
    label: 'Press Release',
    icon: 'megaphone',
    description: 'Media announcements, news releases, and public statements.',
    terminology: {
      bible: 'Media Kit',
      sections: 'Sections',
  ...
  },
  {
    ...
    icon: 'hand',
    description: 'Research grants, funding proposals, and sponsorship requests.',
    terminology: {
      bible: 'Research Base',
  ...
  },
  {
    key: 'MEETING',
    type: 'meeting',
    label: 'Meeting Notes / Minutes',
    icon: 'clipboard-pen',
    description: 'Meeting minutes, agendas, notes, and action item trackers.',
    terminology: {
  ...
  },
  {
    ...
    label: 'Case Study',
    icon: 'search',
    description: 'In-depth analysis of projects, customers, or scenarios.',
    terminology: {
  ...
  },
  {
    ...
    icon: 'file',
    description: 'Any other type of document not covered above.',
    terminology: {
      bible: 'Reference Materials',
      sections: 'Sections',
...
const configByType: Record<string, string> = {}
...
export const WORKSPACE_LABELS = WORKSPACE_CONFIGS.reduce<Record<string, string>>((acc, cfg) => {
  acc[cfg.type] = cfg.label
  return acc
}, {})

export const WORKSPACE_ICONS = WORKSPACE_CONFIGS.reduce<Record<string, string>>((acc, cfg) => {
  acc[cfg.type] = cfg.icon
  return acc
}, {})

export const WORKSPACE_DESCRIPTIONS = WORKSPACE_CONFIGS.reduce<Record<string, string>>(
  (acc, cfg) => {
...
export const VISIBLE_WORKSPACE_CONFIGS = WORKSPACE_CONFIGS.filter((w) =>
  CREATIVE_WORKSPACE_TYPES.includes(w.type)
)
