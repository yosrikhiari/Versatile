import { WORKSPACE_TYPES as WORKSPACE_TYPES_RAW } from './workspace'

// workspace.js builds WORKSPACE_TYPES dynamically, so tsc infers `{}`; the values
// are workspace-type string keys. Cast for typed computed-property access.
