...
export function useDialogueIndexer() {
  ...
  async function indexProjectContent(projectId: any) {
  ...
  async function reindexSubsection(subsection: any) {
  ...
  async function loadDialogueForProject(projectId: any) {
    try {
  ...
  async function loadDialogueByCharacter(projectId: any, speakerId: any) {
    try {
