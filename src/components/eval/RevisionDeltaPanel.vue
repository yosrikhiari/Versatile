    ...
    <template v-if="hasRevision">
      <div class="flex items-center justify-between">
        ...
        <div
          ...
          class="flex items-center gap-1 text-xs font-ui"
          :class="deltaClass(scoreDelta)"
        >
      ...
      <div v-if="!compact" class="grid grid-cols-2 gap-2">
        ...
        <div class="bg-bg-secondary border border-border-subtle rounded-lg p-2.5">
          ...
          <span
            v-if="wordDelta !== 0"
            class="ml-1 text-2xs font-ui"
            :class="wordDelta > 0 ? 'text-success' : 'text-danger'"
          >
