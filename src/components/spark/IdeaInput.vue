...
<template>
  <div class="space-y-5">
    <!-- The idea -->
    <div>
      <label class="block text-11px uppercase tracking-widest text-text-secondary font-ui mb-2">The idea</label>
      <textarea
        :value="idea"
        maxlength="400"
        rows="5"
    ...
    <div class="flex flex-col gap-5 pt-4 border-t border-border-subtle">
      <!-- Emotional registers -->
      <div>
        <label class="block text-11px uppercase tracking-widest text-text-secondary font-ui mb-2.5">Emotional registers · max 2</label>
      ...
      <!-- Target length -->
      <div>
        <label class="block text-11px uppercase tracking-widest text-text-secondary font-ui mb-2.5">Target length</label>
        <div class="inline-flex gap-0.5 p-0.5 bg-bg-tertiary border border-border-subtle rounded-lg">
          <button
            ...
            :class="targetLength === len.value ? 'text-accent' : 'text-text-secondary hover:text-text-primary'"
            :style="targetLength === len.value ? { background: 'rgba(var(--vers-accent-primary-rgb),0.16)' } : {}"
