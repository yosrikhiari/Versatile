            ...
            >
              ...
              >
                <div class="flex items-center gap-3 min-w-0">
                  ...
                  <div class="min-w-0">
                    ...
                    <div class="text-xs text-text-secondary truncate">
                      {{
                        task.progress.label ||
                        task.phases.find((p) => p.status === 'running')?.name ||
                        ''
                      }}
                    </div>
                  </div>
                ...
                <div class="flex items-center gap-2 flex-shrink-0">
                  ...
                  <BaseIcon
                    :name="expandedTasks.has(task.id) ? 'chevron-down' : 'chevron-up'"
                    :size="14"
              ...
              <div
                ...
                class="border-t border-border-subtle divide-y divide-border-subtle/50"
              >
                <div v-for="(phase, pi) in task.phases" :key="pi" class="">
                  ...
                  >
                    ...
                    <div class="flex items-center gap-2 flex-shrink-0">
                      ...
                      <BaseIcon
                        :name="
                          expandedPhases.has(`${task.id}-${pi}`) ? 'chevron-down' : 'chevron-up'
                        "
                        :size="12"
                        class="text-text-secondary"
                      />
                  ...
                  <Transition name="fade">
                    <div v-if="expandedPhases.has(`${task.id}-${pi}`)" class="px-4 pb-3 space-y-2">
