...
export const useSettingsStore = defineStore('settings', () => {
  ...
  function getFeatureDefault(feature: any) {
    return FEATURE_DEFAULTS[feature] || { provider: null, model: null }
  }

  function resolveFeatureProvider(feature: any) {
  ...
  function resolveFeatureModel(feature: any) {
    const override = featureModels.value[feature]
  ...
  function setOllamaEndpoint(url: any) {
    ollamaEndpoint.value = url
    setOllamaConfigEndpoint(url)
    saveSettings()
  }

  function setOllamaModel(model: any) {
    ollamaModel.value = model
    saveSettings()
  }

  async function setOpenaiApiKey(key: any) {
  ...
  function setAIProvider(provider: any) {
    aiProvider.value = provider
    saveSettings()
  }

  function setAIProviderFallback(fallback: any) {
  ...
  function setFeatureModel(feature: any, provider: any, model: any) {
    featureModels.value = {
      ...featureModels.value,
  ...
  async function setStoredApiKey(provider: any, key: any) {
  ...
  function setEmbeddingProvider(provider: any) {
    embeddingProvider.value = provider
    saveSettings()
  }

  function setEmbeddingModel(model: any) {
    embeddingModel.value = model
    saveSettings()
  }

  function setEmbeddingThreshold(threshold: any) {
