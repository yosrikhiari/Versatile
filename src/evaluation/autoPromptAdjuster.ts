 ...
 */
export function autoAdjustPrompt(evalHistory: any, options: any = {}) {
  const {
  ...
  const dimConfig: any = getDimensionsForWorkspace(workspaceType)
  const map: any = dimensionPromptMap.dimensionMap || {}
