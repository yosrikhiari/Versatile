...
public class VoiceProfileController : ApiControllerBase
{
    ...
    public VoiceProfileController(IVoiceProfileService service, IOrganizationContext orgContext) : base(orgContext) => _service = service;
    ...
    [HttpPost]
    public async Task<ActionResult<VoiceProfileDto>> Create(Guid storyId, CreateVoiceProfileRequest request)
    {
    ...
    [HttpPut("{id}")]
    public async Task<ActionResult<VoiceProfileDto>> Update(Guid id, UpdateVoiceProfileRequest request)
    {
