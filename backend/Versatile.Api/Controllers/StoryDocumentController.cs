...
public class StoryDocumentController : ApiControllerBase
{
    ...
    public StoryDocumentController(IStoryDocumentService service, IOrganizationContext orgContext) : base(orgContext) => _service = service;
    ...
    [HttpPost]
    public async Task<ActionResult<StoryDocumentDto>> Create(Guid storyId, CreateStoryDocumentRequest request)
    {
    ...
    [HttpPut("{id}")]
    public async Task<ActionResult<StoryDocumentDto>> Update(Guid id, UpdateStoryDocumentRequest request)
    {
