...
public class GraphEdgeController : ApiControllerBase
{
    ...
    public GraphEdgeController(IGraphEdgeService service, IOrganizationContext orgContext) : base(orgContext) => _service = service;
    ...
    [HttpPost]
    public async Task<ActionResult<GraphEdgeDto>> Create(Guid storyId, CreateGraphEdgeRequest request)
    {
    ...
    [HttpPut("{id}")]
    public async Task<ActionResult<GraphEdgeDto>> Update(Guid id, UpdateGraphEdgeRequest request)
    {
