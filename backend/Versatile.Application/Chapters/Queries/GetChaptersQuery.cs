...
public record GetChaptersQuery(Guid StoryId, Guid? OrganizationId, Guid UserId, int Page = 1, int PageSize = 20, Guid? AfterId = null) : IPagedQuery<ChapterDto>, IRequiresOrganization;
