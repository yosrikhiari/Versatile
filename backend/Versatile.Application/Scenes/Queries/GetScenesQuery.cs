...
public record GetScenesQuery(Guid ChapterId, Guid? OrganizationId, Guid UserId, int Page = 1, int PageSize = 20, Guid? AfterId = null) : IPagedQuery<SceneDto>, IRequiresOrganization;
