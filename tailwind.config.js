  ...
  theme: {
    extend: {
      colors: {
        ...
        'accent-foreground': 'var(--vers-text-on-accent)',
        danger: 'var(--vers-status-danger)',
        success: 'var(--vers-status-success)',
        info: '#5b8cb8',
        'bg-info': '#1e2d3d',
        'text-info': '#7eb8e0',
        warning: 'var(--vers-status-warning)',
      ...
      boxShadow: {
        ...
        'accent-glow': '0 0 0 1px rgba(var(--vers-accent-primary-rgb), 0.4)'
      },
      backdropBlur: {
        xs: '2px'
      },
